...
INSERT INTO agreement_tbl (
    ...
    use_yn
      ...
      (1, 'SERVICE', '서비스 이용약관', '본 약관은 서비스 이용에 관한 기본적인 사항을 규정합니다. 회원은 서비스를 이용함으로써 본 약관에 동의한 것으로 간주됩니다.', 'Y', 'Y'),
...
INSERT INTO verification_tbl (
    ...
    fail_count
      ...
      (1, 1, '테스트회원1', '20000115', 'SKT', '01011112222', '111111', 'SIGN_UP', '2026-07-01 08:55:00', 'Y', 0),
      ...
      (6, NULL, '가입대기회원', '20021212', 'LGU_MVNO', '01099998888', '666666', 'SIGN_UP', '2026-07-24 09:00:00', 'N', 0);
...
INSERT INTO user_random_box_tbl (
    ...
    opened_at
      ...
      (1, 1, 'ATTENDANCE', 1, NULL, 'OPENED', 500, '2026-07-18 09:00:00', '2026-07-18 09:05:00'),
...
INSERT INTO kb_card_product_tbl (
    ...
    created_at
      ...
      (1, 'KB국민 My WE:SH 카드', 'CREDIT', '나만을 위한 맞춤형 혜택을 제공하는 신용카드입니다. 음식, 배달, 커피 등 일상생활 영역에서 할인 혜택을 받을 수 있습니다.', 'my_wesh_card.png', 'my_wesh_apply.html', 15000, '2026-07-01 09:00:00'),
      (2, 'KB국민 톡톡O 카드', 'CREDIT', '온라인 쇼핑과 디지털 생활에 특화된 카드로 쇼핑몰, OTT 등 다양한 영역에서 할인 혜택을 제공합니다.', 'toktok_o_card.png', 'toktok_o_apply.html', 12000, '2026-07-01 09:10:00'),
      (3, 'KB국민 노리2 체크카드', 'CHECK', '대중교통, 카페, 편의점 등 생활 밀착 영역에서 할인 혜택을 제공하는 체크카드입니다.', 'nori2_card.png', 'nori2_apply.html', 0, '2026-07-01 09:20:00'),
      (4, 'KB국민 직장인보너스체크카드', 'CHECK', '직장인을 위한 생활 할인형 체크카드로 교통, 외식, 쇼핑 영역에서 혜택을 제공합니다.', 'bonus_check_card.png', 'bonus_check_apply.html', 0, '2026-07-01 09:30:00');
...
INSERT INTO card_benefit_tbl (
    ...
    created_at
      ...
      (1, 1, 2, '카페 이용 할인', NULL, 10.00, 10000, 300000, '스타벅스 등 카페 이용 시 10% 할인 혜택을 제공합니다.', '2026-07-01 10:00:00'),
      ...
      (7, 4, 7, '자동차 관련 할인', NULL, 5.00, 10000, 300000, '주유 및 자동차 관련 가맹점 이용 시 5% 할인 혜택을 제공합니다.', '2026-07-01 11:00:00');
...
INSERT INTO kb_insurance_product_tbl (
    ...
    created_at
      ...
      (1, 'KB손해보험 다이렉트 자동차보험', '자동차', '자동차 사고 발생 시 대인, 대물, 자기신체손해 등을 보장하는 온라인 전용 자동차보험입니다.', 50000, 'kb_auto_insurance.png', 'kb_auto_apply.html', '2026-07-01 09:00:00'),
      (2, 'KB손해보험 건강보험', '건강', '질병 및 상해로 인한 의료비 부담을 대비할 수 있는 종합 건강보험 상품입니다.', 30000, 'kb_health_insurance.png', 'kb_health_apply.html', '2026-07-01 09:10:00'),
      (3, 'KB손해보험 실손의료비보험', '실손', '병원 진료 및 치료 과정에서 발생하는 의료비를 보장하는 실손형 보험 상품입니다.', 15000, 'kb_silson_insurance.png', 'kb_silson_apply.html', '2026-07-01 09:20:00'),
      (4, 'KB손해보험 운전자보험', '운전자', '자동차 사고 발생 시 운전자에게 필요한 법률 비용 및 사고 관련 위험을 보장합니다.', 12000, 'kb_driver_insurance.png', 'kb_driver_apply.html', '2026-07-01 09:30:00'),
      (5, 'KB손해보험 여행자보험', '여행', '국내외 여행 중 발생할 수 있는 사고, 질병, 휴대품 손해 등을 보장합니다.', 8000, 'kb_travel_insurance.png', 'kb_travel_apply.html', '2026-07-01 09:40:00');
...
INSERT INTO kb_insurance_coverage_tbl (
    ...
    created_at
      ...
      (1, 1, '대인배상', 100000000, '자동차 사고로 타인의 신체 피해 발생 시 손해를 보장합니다.', '사고당', '2026-07-01 10:00:00'),
...
INSERT INTO kb_insurance_recommendation_tbl (
    ...
    created_at
      ...
      (1, 1, 2, '의료와 생활 소비를 함께 고려해 건강보험을 추천합니다.', '2026-07-01 02:00:00'),
