...
(
    ...
    1,
    'ATTACHMENT',
    'background_image-1787465089999.jpg',
    '/images/card_edit_pattern/pattern_circle.svg',
    NULL,
    '/images/card_edit_chip/cardchip_daily.png',
    '2026-08-23 15:04:50'
),
(
    2,
    1,
    'ATTACHMENT',
    'background_image-1787465153093.jpg',
    '/images/card_edit_pattern/pattern_circle.svg',
    NULL,
    '/images/card_edit_chip/cardchip_daily.png',
    '2026-08-23 15:05:53'
...
INSERT INTO custom_card_image_tbl (
    custom_card_image_id,
    custom_card_id,
    custom_card_image_name,
    created_at
)
VALUES
(
    1,
    1,
    'my_custom_card-1787465090007.png',
    '2026-08-23 15:04:50'
),
(
    2,
    2,
    'my_custom_card-1787465153101.png',
    '2026-08-23 15:05:53'
);
...
(
    1,
    1,
    'https://api.iconify.design/fluent-emoji-flat:sparkling-heart.svg',
    73.6328,
    76.25,
    0,
    'SVG'
...
(4, '이효능', '19990505', '01099999999', '$2a$10$LbeEpsFOSzsJWjETK4zvp.Rj4sn0U08EkBhIs3xRN59.sWoMYn7p6', 0, 'N',
 'ACTIVE', '2026-08-23 13:25:48', '2026-08-23 13:25:48', NULL, NULL),
(5, '박준우', '19940505', '01022222222', '$2a$10$9IzoJhHTclL7YxpaaP7dBeTnp3SSUumQLjt50RrQUCci6IhR84gYS', 0, 'N',
 'ACTIVE', '2026-08-23 13:27:27', '2026-08-23 13:27:27', NULL, NULL),
(6, '박우진', '19990505', '01087968428', '$2a$10$JW.z/qtz0Dm1hrreiMC89O3CEKdHdUkf.1kAMf/agEp2x7uZzkSnS', 0, 'N',
 'ACTIVE', '2026-08-23 13:30:08', '2026-08-23 13:30:08', NULL, NULL),
(7, '허현정', '19990505', '01033333333', '$2a$10$I/z/pA6SpDOzT/Sv9D3zN.zAi0OUeEWl4Qi0RARJHFdGZ9CJf08Xi', 0, 'N',
 'ACTIVE', '2026-08-23 13:33:20', '2026-08-23 13:33:20', NULL, NULL);
...
-- ---------------------------------------------------------------------
select * from linked_account_tbl;
...
(7, 4, '004', '670804069150', '이효능', 'Y', 'CONNECTED'),
(8, 5, '004', '183533970178', '박준우', 'Y', 'CONNECTED'),
(9, 6, '004', '074599131198', '박우진', 'Y', 'CONNECTED'),
(10, 7, '004', '640300419571', '허현정', 'Y', 'CONNECTED');
-- ---------------------------------------------------------------------
-- 4. agreement_tbl (6건)
-- ---------------------------------------------------------------------
...
select * from user_agreement_tbl;
-- ---------------------------------------------------------------------
...
(
    ...
    '노랑지갑',
    '포인트를 모으는 중입니다.',
    '1643606-fashion-2309519_1920.jpg',
    '1643606-fashion-2309519_1920-1787463515922.jpg',
    '2026-07-01 09:10:00',
    '2026-08-23 14:38:36'
),
(
...
(
    ...
    '효능',
    '함께 즐거운 추억 많이 만들어요!',
    'daniil_kondrashin-woman-9747618_1920.jpg',
    'daniil_kondrashin-woman-9747618_1920-1787463452207.jpg',
    '2026-08-23 13:25:48',
    '2026-08-23 14:37:33'
),
(
    ...
    '주누',
    '새로운 경험을 즐기는 편이에요.',
    'pexels-couple-1838783_1920.jpg',
    'pexels-couple-1838783_1920-1787463461589.jpg',
    '2026-08-23 13:27:27',
    '2026-08-23 14:37:42'
),
(
    ...
    6,
    '바구니',
    '소소한 일상과 맛있는 음식을 좋아해요.',
    'birgl-dog-4671215_1920.jpg',
    'birgl-dog-4671215_1920-1787463484173.jpg',
    '2026-08-23 13:30:08',
    '2026-08-23 14:38:05'
),
(
    ...
    '현정',
    '맛집과 여행 이야기를 좋아해요!',
    'engin_akyurt-woman-2604283_1920.jpg',
    'engin_akyurt-woman-2604283_1920-1787463470337.jpg',
    '2026-08-23 13:33:20',
    '2026-08-23 14:37:51'
);
-- ---------------------------------------------------------------------
...
(4, 4, 0, '2026-08-23 13:25:48'),
(5, 5, 0, '2026-08-23 13:27:27'),
(6, 6, 0, '2026-08-23 13:30:08'),
(7, 7, 0, '2026-08-23 13:33:20');
...
-- ---------------------------------------------------------------------
select * from spending_analysis_tbl;
DESC card_tbl;
...
VALUES (
    ...
    2,
    '카페로 시작하는 하루',
    '카페를 중심으로 작은 즐거움을 매일 찾는 라이프스타일이 돋보여요. 앱에서 이번 달 카페 지출 내역을 한눈에 확인해 보세요.',
    '2026-08-23 15:30:11'
);
...
VALUES
    (1, 1, 4, '2026-08-23 13:49:00'),
    (2, 4, 1, '2026-08-23 13:49:00'),
    (3, 1, 6, '2026-08-23 13:49:09'),
    (4, 6, 1, '2026-08-23 13:49:09'),
    (5, 1, 7, '2026-08-23 13:49:20'),
    (6, 7, 1, '2026-08-23 13:49:20'),
    (7, 1, 5, '2026-08-23 14:39:01'),
    (8, 5, 1, '2026-08-23 14:39:01');
...
select * from financial_transaction_tbl;
-- ---------------------------------------------------------------------
...
(7, 4, '003', '004096492827', '이효능', 100000, '1234', '2026-08-23 13:25:48'),
(8, 4, '004', '670804069150', '이효능', 100000, '1234', '2026-08-23 13:25:48'),
(9, 4, '011', '513433344185', '이효능', 100000, '1234', '2026-08-23 13:25:48'),
(10, 4, '023', '958455941019', '이효능', 100000, '1234', '2026-08-23 13:25:48'),
(11, 4, '088', '246228487736', '이효능', 100000, '1234', '2026-08-23 13:25:48'),
(12, 4, '020', '433894082895', '이효능', 100000, '1234', '2026-08-23 13:25:48'),
(13, 4, '090', '333380628903', '이효능', 100000, '1234', '2026-08-23 13:25:48'),
(14, 4, '089', '100254436725', '이효능', 100000, '1234', '2026-08-23 13:25:48'),
(15, 4, '092', '100059746879', '이효능', 100000, '1234', '2026-08-23 13:25:48'),
(16, 4, '081', '338535710406', '이효능', 100000, '1234', '2026-08-23 13:25:48'),

(17, 5, '003', '707060560186', '박준우', 100000, '1234', '2026-08-23 13:27:27'),
(18, 5, '004', '183533970178', '박준우', 100000, '1234', '2026-08-23 13:27:27'),
(19, 5, '011', '099226561748', '박준우', 100000, '1234', '2026-08-23 13:27:27'),
(20, 5, '023', '731395078654', '박준우', 100000, '1234', '2026-08-23 13:27:27'),
(21, 5, '088', '658304872990', '박준우', 100000, '1234', '2026-08-23 13:27:27'),
(22, 5, '020', '608625752145', '박준우', 100000, '1234', '2026-08-23 13:27:27'),
(23, 5, '090', '333324556863', '박준우', 100000, '1234', '2026-08-23 13:27:27'),
(24, 5, '089', '100337153903', '박준우', 100000, '1234', '2026-08-23 13:27:27'),
(25, 5, '092', '100042543205', '박준우', 100000, '1234', '2026-08-23 13:27:27'),
(26, 5, '081', '829547361221', '박준우', 100000, '1234', '2026-08-23 13:27:27'),

(27, 6, '003', '056449638482', '박우진', 100000, '1234', '2026-08-23 13:30:08'),
(28, 6, '004', '074599131198', '박우진', 100000, '1234', '2026-08-23 13:30:08'),
(29, 6, '011', '345268675849', '박우진', 100000, '1234', '2026-08-23 13:30:08'),
(30, 6, '023', '540304512264', '박우진', 100000, '1234', '2026-08-23 13:30:08'),
(31, 6, '088', '083519120726', '박우진', 100000, '1234', '2026-08-23 13:30:08'),
(32, 6, '020', '740548376631', '박우진', 100000, '1234', '2026-08-23 13:30:08'),
(33, 6, '090', '333399247785', '박우진', 100000, '1234', '2026-08-23 13:30:08'),
(34, 6, '089', '100304280138', '박우진', 100000, '1234', '2026-08-23 13:30:08'),
(35, 6, '092', '100026653071', '박우진', 100000, '1234', '2026-08-23 13:30:08'),
(36, 6, '081', '647778570890', '박우진', 100000, '1234', '2026-08-23 13:30:08'),

(37, 7, '003', '827952722168', '허현정', 100000, '1234', '2026-08-23 13:33:20'),
(38, 7, '004', '640300419571', '허현정', 100000, '1234', '2026-08-23 13:33:20'),
(39, 7, '011', '954036908940', '허현정', 100000, '1234', '2026-08-23 13:33:20'),
(40, 7, '023', '547017954532', '허현정', 100000, '1234', '2026-08-23 13:33:20'),
(41, 7, '088', '557030755111', '허현정', 100000, '1234', '2026-08-23 13:33:20'),
(42, 7, '020', '422726254047', '허현정', 100000, '1234', '2026-08-23 13:33:20'),
(43, 7, '090', '333354308851', '허현정', 100000, '1234', '2026-08-23 13:33:20'),
(44, 7, '089', '100846387065', '허현정', 100000, '1234', '2026-08-23 13:33:20'),
(45, 7, '092', '100019575934', '허현정', 100000, '1234', '2026-08-23 13:33:20'),
(46, 7, '081', '689580727519', '허현정', 100000, '1234', '2026-08-23 13:33:20');
-- ---------------------------------------------------------------------
...
VALUES
    (1, '07986_img.png', '9445-4100-1111-2222', '12/28', '777', '1234', '노리2 체크카드 (Play)'),
    (2, '09137_img.png', '4579-7300-3333-4444', '11/29', '888', '1234', 'KB국민 마이 위시(My WE:SH) 카드'),
    (3, '09106_img.png', '9445-4300-5555-6666', '10/30', '999', '1234', 'KB국민 다담카드'),
    (4, 'my_custom_card-1787465090007.png', '4636540643470855', '08/28', '997', '1234', '나만의 카드'),
    (5, 'my_custom_card-1787465153101.png', '4636545981544988', '08/27', '077', '1234', '나만의 카드');
-- ---------------------------------------------------------------------
...
VALUES
    (2, 1, 80, 'ACTIVE', 'TRANSFER', '정말 행복한 하루 !', 'FRIEND',
     '2026-08-23 14:50:32', '2026-08-23 14:50:32'),

    (3, 1, 1, 'DELETED', 'CARD', '사랑하는 친구들과 함께 !', 'PUBLIC',
     '2026-08-23 15:05:11', '2026-08-23 15:05:26'),

    (4, 1, 2, 'ACTIVE', 'CARD', '사랑하는 친구들과 함께', 'PUBLIC',
     '2026-08-23 15:06:02', '2026-08-23 15:06:02'),

    (5, 4, 7, 'ACTIVE', 'EVENT', 'undefined', 'PUBLIC',
     '2026-08-23 15:21:08', '2026-08-23 15:21:08'),

    (6, 5, 81, 'ACTIVE', 'TRANSFER', '케이크 맛있게 먹었어요❤️', 'PUBLIC',
     '2026-08-23 15:25:02', '2026-08-23 15:25:02'),

    (7, 7, 83, 'ACTIVE', 'TRANSFER', '송금 완료', 'PRIVATE',
     '2026-08-23 15:28:35', '2026-08-23 15:28:35'),

    (8, 7, 84, 'ACTIVE', 'TRANSFER', '송금 완료', 'PRIVATE',
     '2026-08-23 15:28:52', '2026-08-23 15:28:52'),

    (9, 7, 85, 'ACTIVE', 'TRANSFER', '송금 완료', 'PRIVATE',
     '2026-08-23 15:29:07', '2026-08-23 15:29:07'),

    (10, 7, 86, 'ACTIVE', 'TRANSFER', '송금 완료', 'PRIVATE',
     '2026-08-23 15:29:24', '2026-08-23 15:29:24'),

    (11, 7, 87, 'ACTIVE', 'TRANSFER', '송금 완료', 'PRIVATE',
     '2026-08-23 15:29:52', '2026-08-23 15:29:52'),

    (12, 7, 1, 'ACTIVE', 'ANALYSIS', '나는 카페로 시작하는 하루 ㅎㅎ', 'PUBLIC',
     '2026-08-23 15:30:43', '2026-08-23 15:30:43');
...
VALUES
    (3, 2, '5-1787464232306.png'),
    (4, 2, '7-1787464232307.png'),
	(5, 6, '8-1787466302073.png');
...
VALUES
    (1, 2, 5, '2026-08-23 14:50:42'),
    (2, 2, 1, '2026-08-23 14:50:43'),
    (3, 2, 7, '2026-08-23 14:50:46'),
    (4, 2, 6, '2026-08-23 14:50:48'),
    (5, 2, 4, '2026-08-23 14:50:55'),

    (6, 4, 4, '2026-08-23 15:17:04'),
    (7, 4, 5, '2026-08-23 15:17:06'),
    (8, 4, 7, '2026-08-23 15:17:08'),
    (9, 4, 6, '2026-08-23 15:17:11'),
    (10, 4, 1, '2026-08-23 15:19:09'),

    (11, 12, 4, '2026-08-23 15:32:05'),
    (12, 6, 4, '2026-08-23 15:32:06'),
    (13, 5, 4, '2026-08-23 15:32:07'),

    (14, 12, 7, '2026-08-23 15:32:09'),
    (15, 6, 7, '2026-08-23 15:32:10'),
    (16, 5, 7, '2026-08-23 15:32:11'),

    (17, 12, 6, '2026-08-23 15:32:38'),
    (18, 6, 6, '2026-08-23 15:32:39'),
    (19, 5, 6, '2026-08-23 15:32:40'),

    (20, 12, 5, '2026-08-23 15:33:11'),
    (21, 6, 5, '2026-08-23 15:33:12'),
    (22, 5, 5, '2026-08-23 15:33:14'),

    (23, 12, 1, '2026-08-23 15:33:17'),
    (24, 6, 1, '2026-08-23 15:33:18'),
    (25, 5, 1, '2026-08-23 15:33:19');
...
VALUES
    (1, 2, 4, '저도 가고 싶어요 !', '2026-08-23 14:52:15', '2026-08-23 14:52:15'),
    (2, 2, 7, '보기만 해도 배고프네요ㅜ', '2026-08-23 14:52:38', '2026-08-23 14:52:38'),
    (3, 2, 5, '나도 행복했어, 다음에 또 가자ㅎㅎ', '2026-08-23 14:53:17', '2026-08-23 14:53:17'),
    (4, 2, 6, '와! 맛있겠다 ', '2026-08-23 14:53:39', '2026-08-23 14:53:39'),

    (5, 4, 4, '나만의 카드 퍼가요!', '2026-08-23 15:17:35', '2026-08-23 15:17:35'),
    (6, 4, 5, '너무 이쁘다', '2026-08-23 15:17:42', '2026-08-23 15:17:42'),
    (7, 4, 7, '낭만 ㄷㄷ...', '2026-08-23 15:17:46', '2026-08-23 15:17:46'),
    (8, 4, 6, '나도 지금 바로 신청해야지', '2026-08-23 15:18:02', '2026-08-23 15:18:02'),

    (9, 6, 5, '분위기 좋다', '2026-08-23 15:33:38', '2026-08-23 15:33:38'),
    (10, 6, 7, '나도 갈래', '2026-08-23 15:33:44', '2026-08-23 15:33:44'),
    (11, 6, 6, '빨대가 특이하네ㅋㅋ', '2026-08-23 15:33:57', '2026-08-23 15:33:57'),
    (12, 6, 7, '어디예요? 분위기 좋다', '2026-08-23 15:34:15', '2026-08-23 15:34:15');
-- ---------------------------------------------------------------------
...
-- ---------------------------------------------------------------------
select * from card_application_history_tbl;
...
VALUES
    (1, 1, 4, 'SUCCESS', '2026-08-23 15:04:50'),
    (2, 2, 5, 'SUCCESS', '2026-08-23 15:05:53');
...
VALUES
    (1, 1, 1, 'KB', 'N', 'N', '2026-08-23 13:23:55'),
    (2, 1, 2, 'KB', 'N', 'N', '2026-08-23 13:23:55'),
    (3, 1, 3, 'KB', 'N', 'N', '2026-08-23 13:23:55'),
    (4, 2, 3, 'KB', 'Y', 'N', '2026-08-23 13:23:55'),
    (5, 1, 5, 'KB', 'Y', 'N', '2026-08-23 15:06:40');
-- ---------------------------------------------------------------------
