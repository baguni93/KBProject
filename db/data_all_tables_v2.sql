...
(
    ...
    CONSTRAINT chk_point_transaction_reason
        CHECK (reason_type IN ('DEPOSIT', 'ATTENDANCE', 'RANDOM_BOX', 'CONVERSION', 'EVENT'))
);
...
INSERT INTO agreement_tbl (agreement_id,
                           ...
                           required_yn,
                           use_yn)
VALUES (1, 'SERVICE', '서비스 이용약관', '서비스 이용에 필요한 기본 약관입니다.', 'Y', 'Y'),
...
INSERT INTO kb_card_product_tbl (card_product_id,
                                 ...
                                 annual_fee,
                                 created_at)
VALUES (1, 'KB국민 My WE:SH 카드', 'CREDIT', '음식과 카페 생활 영역에 특화된 카드입니다.', 'my_wesh.png', 'my_wesh_apply.html', 15000,
        '2026-07-01 09:00:00'),
       (2, 'KB국민 톡톡O 카드', 'CREDIT', '온라인과 생활 할인에 특화된 카드입니다.', 'toktok_o.png', 'toktok_o_apply.html', 12000,
        '2026-07-01 09:10:00'),
       (3, 'KB국민 노리2 체크카드', 'CHECK', '교통과 카페 할인을 제공하는 체크카드입니다.', 'nori2.png', 'nori2_apply.html', 0,
        '2026-07-01 09:20:00');
...
INSERT INTO card_benefit_tbl (card_benefit_id,
                              ...
                              benefit_description,
                              created_at)
VALUES (1, 1, 1, '음식점 할인', 1000, NULL, 15000, 300000, '음식점 결제 건당 1,000원 할인', '2026-07-01 10:00:00'),
...
INSERT INTO kb_insurance_product_tbl (insurance_product_id,
                                      ...
                                      application_url,
                                      created_at)
VALUES (1, 'KB 5.10.10 플러스 건강보험', '건강', '질병과 상해 위험을 보장하는 건강보험입니다.', 30000, 'health.png', 'health_apply.html',
        '2026-07-01 09:00:00'),
       (2, 'KB손보 실손의료비보장보험', '실손', '실제 발생한 의료비를 보장하는 상품입니다.', 15000, 'medical.png', 'medical_apply.html',
        '2026-07-01 09:10:00'),
       (3, 'KB손해보험 여행자보험', '여행자', '여행 중 발생할 수 있는 사고를 보장합니다.', 8000, 'travel.png', 'travel_apply.html',
        '2026-07-01 09:20:00');
...
INSERT INTO kb_insurance_coverage_tbl (insurance_coverage_id,
                                       ...
                                       coverage_limit,
                                       created_at)
VALUES (1, 1, '암 진단비', 30000000, '약관상 암 진단 확정 시 보장', '최초 1회', '2026-07-01 10:00:00'),
...
INSERT INTO kb_insurance_recommendation_tbl (insurance_recommendation_id,
                                             ...
                                             created_at)
VALUES (1, 1, 1, '의료와 생활 소비를 함께 고려해 건강보험을 추천합니다.', '2026-07-01 02:00:00'),
...
-- 전체 테이블 건수 확인
SELECT 'tbl_member' AS table_name, COUNT(*) AS row_count
FROM tbl_member
UNION ALL
SELECT 'tbl_member_auth' AS table_name, COUNT(*) AS row_count
FROM tbl_member_auth
UNION ALL
SELECT 'user_tbl' AS table_name, COUNT(*) AS row_count
FROM user_tbl
UNION ALL
SELECT 'bank_tbl' AS table_name, COUNT(*) AS row_count
FROM bank_tbl
UNION ALL
SELECT 'linked_account_tbl' AS table_name, COUNT(*) AS row_count
FROM linked_account_tbl
UNION ALL
SELECT 'agreement_tbl' AS table_name, COUNT(*) AS row_count
FROM agreement_tbl
UNION ALL
SELECT 'user_agreement_tbl' AS table_name, COUNT(*) AS row_count
FROM user_agreement_tbl
UNION ALL
SELECT 'wallet_tbl' AS table_name, COUNT(*) AS row_count
FROM wallet_tbl
UNION ALL
SELECT 'verification_tbl' AS table_name, COUNT(*) AS row_count
FROM verification_tbl
UNION ALL
SELECT 'profile_tbl' AS table_name, COUNT(*) AS row_count
FROM profile_tbl
UNION ALL
SELECT 'notification_setting_tbl' AS table_name, COUNT(*) AS row_count
FROM notification_setting_tbl
UNION ALL
SELECT 'refresh_token_tbl' AS table_name, COUNT(*) AS row_count
FROM refresh_token_tbl
UNION ALL
SELECT 'spending_category_tbl' AS table_name, COUNT(*) AS row_count
FROM spending_category_tbl
UNION ALL
SELECT 'point_wallet_tbl' AS table_name, COUNT(*) AS row_count
FROM point_wallet_tbl
UNION ALL
SELECT 'point_transaction_tbl' AS table_name, COUNT(*) AS row_count
FROM point_transaction_tbl
UNION ALL
SELECT 'user_random_box_tbl' AS table_name, COUNT(*) AS row_count
FROM user_random_box_tbl
UNION ALL
SELECT 'attendance_tbl' AS table_name, COUNT(*) AS row_count
FROM attendance_tbl
UNION ALL
SELECT 'point_conversion_history_tbl' AS table_name, COUNT(*) AS row_count
FROM point_conversion_history_tbl
UNION ALL
SELECT 'spending_analysis_tbl' AS table_name, COUNT(*) AS row_count
FROM spending_analysis_tbl
UNION ALL
SELECT 'spending_analysis_category_tbl' AS table_name, COUNT(*) AS row_count
FROM spending_analysis_category_tbl
UNION ALL
SELECT 'kb_card_product_tbl' AS table_name, COUNT(*) AS row_count
FROM kb_card_product_tbl
UNION ALL
SELECT 'card_benefit_tbl' AS table_name, COUNT(*) AS row_count
FROM card_benefit_tbl
UNION ALL
SELECT 'card_recommendation_tbl' AS table_name, COUNT(*) AS row_count
FROM card_recommendation_tbl
UNION ALL
SELECT 'kb_insurance_product_tbl' AS table_name, COUNT(*) AS row_count
FROM kb_insurance_product_tbl
UNION ALL
SELECT 'kb_insurance_coverage_tbl' AS table_name, COUNT(*) AS row_count
FROM kb_insurance_coverage_tbl
UNION ALL
SELECT 'kb_insurance_recommendation_tbl' AS table_name, COUNT(*) AS row_count
FROM kb_insurance_recommendation_tbl
UNION ALL
SELECT 'friend_request_tbl' AS table_name, COUNT(*) AS row_count
FROM friend_request_tbl
UNION ALL
SELECT 'friend_tbl' AS table_name, COUNT(*) AS row_count
FROM friend_tbl
UNION ALL
SELECT 'settlement_tbl' AS table_name, COUNT(*) AS row_count
FROM settlement_tbl
UNION ALL
SELECT 'settlement_member_tbl' AS table_name, COUNT(*) AS row_count
FROM settlement_member_tbl
UNION ALL
SELECT 'notification_tbl' AS table_name, COUNT(*) AS row_count
FROM notification_tbl
UNION ALL
SELECT 'financial_transaction_tbl' AS table_name, COUNT(*) AS row_count
FROM financial_transaction_tbl
UNION ALL
SELECT 'account_dummy_tbl' AS table_name, COUNT(*) AS row_count
FROM account_dummy_tbl
UNION ALL
SELECT 'account_transaction_tbl' AS table_name, COUNT(*) AS row_count
FROM account_transaction_tbl
UNION ALL
SELECT 'wallet_transaction_tbl' AS table_name, COUNT(*) AS row_count
FROM wallet_transaction_tbl
UNION ALL
SELECT 'card_tbl' AS table_name, COUNT(*) AS row_count
FROM card_tbl
UNION ALL
SELECT 'registered_card_tbl' AS table_name, COUNT(*) AS row_count
FROM registered_card_tbl
UNION ALL
SELECT 'payment_token_tbl' AS table_name, COUNT(*) AS row_count
FROM payment_token_tbl
UNION ALL
SELECT 'receipt_memo_tbl' AS table_name, COUNT(*) AS row_count
FROM receipt_memo_tbl
UNION ALL
SELECT 'feed_tbl' AS table_name, COUNT(*) AS row_count
FROM feed_tbl
UNION ALL
SELECT 'feed_image_tbl' AS table_name, COUNT(*) AS row_count
FROM feed_image_tbl
UNION ALL
SELECT 'feed_like_tbl' AS table_name, COUNT(*) AS row_count
FROM feed_like_tbl
UNION ALL
SELECT 'feed_comment_tbl' AS table_name, COUNT(*) AS row_count
FROM feed_comment_tbl
UNION ALL
SELECT 'card_asset_tbl' AS table_name, COUNT(*) AS row_count
FROM card_asset_tbl
UNION ALL
SELECT 'file_image_tbl' AS table_name, COUNT(*) AS row_count
FROM file_image_tbl
UNION ALL
SELECT 'custom_image_tbl' AS table_name, COUNT(*) AS row_count
FROM custom_image_tbl
UNION ALL
SELECT 'card_application_history_tbl' AS table_name, COUNT(*) AS row_count
FROM card_application_history_tbl
UNION ALL
SELECT 'event_tbl' AS table_name, COUNT(*) AS row_count
FROM event_tbl
UNION ALL
SELECT 'event_reward_tbl' AS table_name, COUNT(*) AS row_count
FROM event_reward_tbl
UNION ALL
SELECT 'event_participation_tbl' AS table_name, COUNT(*) AS row_count
FROM event_participation_tbl
UNION ALL
SELECT 'event_reward_receive_tbl' AS table_name, COUNT(*) AS row_count
FROM event_reward_receive_tbl
UNION ALL
SELECT 'event_challenge_tbl' AS table_name, COUNT(*) AS row_count
FROM event_challenge_tbl
UNION ALL
SELECT 'event_challenge_user_tbl' AS table_name, COUNT(*) AS row_count
FROM event_challenge_user_tbl
UNION ALL
SELECT 'card_company_tbl' AS table_name, COUNT(*) AS row_count
FROM card_company_tbl
UNION ALL
SELECT 'linked_card_tbl' AS table_name, COUNT(*) AS row_count
FROM linked_card_tbl
ORDER BY table_name;
