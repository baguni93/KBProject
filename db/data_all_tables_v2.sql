...
VALUES (1, 'SERVICE', '서비스 이용약관', '본 약관은 서비스 이용에 관한 기본적인 사항을 규정합니다. 회원은 서비스를 이용함으로써 본 약관에 동의한 것으로 간주됩니다.', 'Y', 'Y'),
       ...
       (4, 'ANALYSIS_REQUIRED', '소비정보 수집 및 분석 동의','맞춤형 소비 분석을 제공하기 위해 결제 거래의 가맹점명, 결제금액, 결제일시 및 소비 카테고리 정보를 수집·이용합니다. 수집된 정보는 소비 패턴 분석과 분석 결과 제공 목적으로만 사용됩니다.','Y', 'Y'),
       (5, 'ANALYSIS_OPTIONAL', '맞춤형 금융상품 추천 정보 활용 동의','소비 분석 결과를 바탕으로 카드와 보험 등 맞춤형 금융상품을 추천하기 위해 분석 결과를 활용합니다. 선택 약관에 동의하지 않아도 소비 분석 기능은 이용할 수 있습니다.', 'N', 'Y');
-- ---------------------------------------------------------------------
