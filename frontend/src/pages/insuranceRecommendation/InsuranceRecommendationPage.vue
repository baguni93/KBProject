<template>
  <div class="kb-mobile-page insurance-recommendation-page">
    ...
    <main class="recommendation-content-start">
      <!-- 상단 추천 안내 -->
      <section v-if="!loading" class="recommendation-intro kb-card">
        <div class="intro-topline">
          ...
          <span class="intro-badge text-13-bold">
            12개월 소비분석 기반
          </span>
        </div>
        ...
        <div class="intro-copy">
          ...
          <p class="text-13">
            실제 소비내역을 분석해 관련 보장을 받을 수 있는 보험을 골랐어요.
          </p>
        </div>
      ...
      <div
          v-if="loading"
          class="kb-card kb-loading recommendation-loading"
      >
      ...
      <template v-else-if="recommendationData">
        ...
        <section class="recommendation-meta">
          <span class="text-13">
            최근 {{ recommendationData.analysisPeriod }}개월 분석
          </span>
        ...
        <section class="kb-section recommendation-list-section">
            ...
            >
              ...
              <div class="insurance-item__visual">
                <InsuranceProductImage
                    v-if="
                    getImage(insurance) &&
                    !isImageFailed(insurance.insuranceProductId)
                  "
              ...
              <div class="insurance-item__body">
                ...
                <div
                    v-if="insurance.recommendationReason"
                    class="reason-box"
                >
                  ...
                  <p class="text-13">
                    {{ insurance.recommendationReason }}
                  </p>
                </div>
          ...
          <div
              v-else
              class="kb-card kb-empty-state empty-recommendation"
          >
      ...
      >
        ...
        <strong class="text-15-bold">
          보험 추천 결과를 불러오지 못했습니다.
        </strong>

        <p class="text-13">
          {{
            message ||
            '백엔드 서버와 추천 데이터를 확인한 뒤 다시 시도해 주세요.'
          }}
        </p>
...
import InsuranceProductImage from '@/components/insuranceRecommendation/InsuranceProductImage.vue';
...
.insurance-item__visual :deep(img) {
  width: auto;
  height: auto;
  max-width: 205px;
  max-height: 128px;
